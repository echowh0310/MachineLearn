...
async def train_model(
    ...
    :param problem_type: 问题类型（classification/regression）
    :param model_type: 模型类型（random_forest/xgboost/lightgbm/svm/knn/decision_tree等）
    :param train_request: 训练请求参数（dataset_id, split_id, model_params）
    :return: 训练结果（模型参数、评估指标、模型保存路径等）
    """
    # 1. 基础参数校验
